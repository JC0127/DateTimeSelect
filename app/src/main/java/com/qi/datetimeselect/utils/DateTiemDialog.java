package com.qi.datetimeselect.utils;
...
import com.qi.datetimeselect.R;

import java.util.ArrayList;
import java.util.List;

/**
 * Created by jings on 2017/10/19.
 */

public class DateTiemDialog {
    ...
    public DateTiemDialog(Context context) {
        super();
        mContext = context;
    ...
    private View initDatePicker() {
        View inflate = LayoutInflater.from(mContext).inflate(
                R.layout.date_time_layout, null);
        mDatePicker = (DatePicker) inflate
                .findViewById(R.id.data_picker);
